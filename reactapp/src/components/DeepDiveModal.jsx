...
import { X, MapPin, Info, Shield, History as HistoryIcon, IndianRupee, Flame, Calculator as CalcIcon } from 'lucide-react';
    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      <div className="ddm-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="ddm-scroll-container">
          {activeTab === 'Overview' && <OverviewTab inv={inv} comparisonData={comparisonData} />}
